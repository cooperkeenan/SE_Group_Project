...
// Disambiguate your DTOs from the MAUI Location type
using ApiLocation = EnviroMonitorApp.Services.Apis.Location;
using ApiSensor   = EnviroMonitorApp.Services.Apis.Sensor;
            ...
            var locsDto = new LocationResponse
            {
                Results = new[]
                {
                    new ApiLocation {
                        Id = 1,
                        Sensors = new[] {
                            new ApiSensor { Id = 101, Parameter = new Parameter { Name = "NO2" } },
                            new ApiSensor { Id = 102, Parameter = new Parameter { Name = "SO2" } }
                        }
                    },
                    new ApiLocation {
                        Id = 2,
                        Sensors = new[] {
                            new ApiSensor { Id = 201, Parameter = new Parameter { Name = "PM25" } },
                            new ApiSensor { Id = 202, Parameter = new Parameter { Name = "PM10" } }
                        }
                    }
                }
            };
